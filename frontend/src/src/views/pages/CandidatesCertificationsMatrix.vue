...
<template>
  <div class="card">
    ...
    <div>
      <h6>Candidate Certifications</h6>
      <DataTable :value="filteredCandidateCertifications" :scrollable="true" scrollHeight="40vh" scrollDirection="vertical">
        <Column field="certification" header="Certification" :sortable="true" frozen alignFrozen="left"></Column>
        <Column
          v-for="email in candidateEmails"
          :key="email"
          :field="`emails.${email}`"
          :header="email"
          :sortable="true"
