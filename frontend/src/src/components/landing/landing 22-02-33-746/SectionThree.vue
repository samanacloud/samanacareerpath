...
const details = ref([
    {
        ...
        description: 'Multi-region server deployment ensures data sovereignty and compliance with local regulations across different jurisdictions.',
        icon: '/demo/images/landing/icons/icon-1.svg'
    },
    {
        title: 'Expense Integration',
        description: 'Seamless integration with Expensify and other expense management tools coming soon. Automatically sync project expenses and receipts.',
        icon: '/demo/images/landing/icons/icon-2.svg'
    },
    {
        title: 'Team Time Tracking',
        description: 'Collaborative time tracking where team members can log hours, categorize activities, and maintain accurate project timesheets.',
        icon: '/demo/images/landing/icons/icon-3.svg'
    },
    {
        title: 'Automated Reporting',
        description: 'Generate comprehensive project status reports automatically based on tracked time, milestones, and team progress.',
        icon: '/demo/images/landing/icons/icon-4.svg'
    },
    {
        title: 'Resource Analytics',
        description: 'Real-time insights into team utilization, project burn rates, and resource allocation across multiple projects.',
        icon: '/demo/images/landing/icons/icon-5.svg'
    },
    {
        title: 'API Integration',
        description: 'Robust API support for connecting with your existing tools and systems, enabling seamless workflow automation.',
...
<template>
    <section class="relative py-12 lg:py-24">
        <div class="landing-container mx-auto w-full flex flex-col items-center">
            <div class="badge mx-0">Core Features</div>
            <h4 class="title-h4 lg:title-h2 text-center mt-6">
                Enterprise-Grade 
                <span class="text-primary-600">Project Management</span>
            </h4>
            <p class="body-small md:body-large text-center mt-6 max-w-[56rem]">
                A comprehensive suite of tools designed for global teams, ensuring compliance, 
                collaboration, and seamless integration with your existing workflow.
            </p>
        </div>
                ...
                <div class="absolute scale-100 top-0 left-1/2 -translate-x-1/2 h-full w-[102rem] mx-auto flex items-end justify-end overflow-hidden">
                    ...
                    <div class="z-[2] absolute top-[10rem] left-[15rem] animate-float">
                        <LazyImage
                            ...
                            alt="Global Server Distribution"
                        />
                    </div>
                    <div class="z-[3] absolute top-[7rem] left-[32rem]">
                        <LazyImage
                            ...
                            alt="Expense Integration Dashboard"
                        />
                    </div>
